...
async function main() {
  ...
  const sql = `-- POS Rahmat — Seed data
-- Generated at build time. Password hash pre-computed.
...
VALUES ('Food & Beverages', 'food-beverages', 'All food and drink items'),
...
VALUES ('Nasi Goreng', 'FNB-001', '8991234567890', 'Indonesian fried rice', 25000, 15000, 50, 10, 1, true, true),
...
VALUES ('John Doe', 'john@example.com', '081234567890', 'Jl. Merdeka No. 1', 150),
...
VALUES ('INV-20250601-001', 1, 1, 53000, 5300, 0, 58300, 'cash', 'paid', 'completed'),
...
VALUES (1, '2025-06-01 08:00:00', '2025-06-01 17:00:00', 500000, 1250000, 1280000, 'closed'),
...
VALUES ('Toko Maju Jaya', 'Jl. Example No. 123, Jakarta', '021-12345678', 'contact@tokomajujaya.com', 10, 'IDR', 'Terima kasih telah berbelanja!');

-- Tax settings
INSERT INTO \`tax_settings\` (\`name\`, \`rate\`, \`type\`, \`is_default\`, \`active\`)
VALUES ('PPN', 10, 'percentage', true, true);
`

  const outDir = path.resolve(__dirname, "..", "dist", "sql")
  fs.mkdirSync(outDir, { recursive: true })
  fs.writeFileSync(path.join(outDir, "seed.sql"), sql, "utf8")
  console.log("Seed SQL generated:", path.join(outDir, "seed.sql"))
}

main().catch((err) => {
  console.error("Failed to generate seed SQL:", err.message)
  process.exit(1)
})
